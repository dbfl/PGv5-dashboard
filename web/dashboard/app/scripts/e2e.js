...
var encParams = function(paramStr,key) {
	var bits = 256;
	var utf8encoded = pidCryptUtil.decodeUTF8(paramStr);
	var aes = new pidCrypt.AES.CTR();
	aes.initEncrypt(utf8encoded, key, {
		nBits : bits
	});
...
var decParams = function(paramStr,key) {
	var bits = 256;
	var aes = new pidCrypt.AES.CTR();
	return aes.decryptText(paramStr, key, {
		nBits : bits
	});
};
